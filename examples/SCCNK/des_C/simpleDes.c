...
extern void *snet_source(void *hnd, int arg_0, int arg_1, int arg_2, int arg_3, int arg_4, int arg_5, int arg_6, int arg_7, int arg_8);
...
snet_handle_t *SNetCall__snet_source(snet_handle_t *handle, int arg_0, int arg_1, int arg_2, int arg_3, int arg_4, int arg_5, int arg_6, int arg_7, int arg_8)
{
  return snet_source(handle, arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8);
}
...
static snet_handle_t *SNet__simpleDes__snet_source(snet_handle_t *hnd)
{
  ...
  stag_sleep_micro = SNetRecTakeTag(rec, T__simpleDes__sleep_micro);

  stag_change_mess = SNetRecTakeTag(rec, T__simpleDes__change_mess);

  stag_change_percent = SNetRecTakeTag(rec, T__simpleDes__change_percent);

  stag_window_size = SNetRecTakeTag(rec, T__simpleDes__window_size);

  stag_thresh_hold = SNetRecTakeTag(rec, T__simpleDes__thresh_hold);

  stag_skip_update = SNetRecTakeTag(rec, T__simpleDes__skip_update);

  return(SNetCall__snet_source(hnd, stag_mess, stag_size, stag_num_node, stag_sleep_micro, stag_change_mess, stag_change_percent, stag_window_size, stag_thresh_hold, stag_skip_update));
}
...
static snet_stream_t *SNet__simpleDes___IN___SL___SR___IS___SL___SR___ST(snet_stream_t *in_buf, snet_info_t *info, int location)
{
  snet_stream_t *out_buf = NULL;
...
static snet_stream_t *SNet____STAR_INCARNATE_simpleDes___IN___SL___SR___IS___SL___SR(snet_stream_t *in_buf, snet_info_t *info, int location)
{
  snet_stream_t *out_buf = NULL;
  ...
  out_buf = SNetStarIncarnate(in_buf, info, location, 
              ...
              SNetExprListCreate(1, 
                SNetEeq( 
                  ...
                  SNetEconsti( 16))), 
              &SNet__simpleDes___IN___SL___SR___IS___SL___SR___ST, 
              &SNet____STAR_INCARNATE_simpleDes___IN___SL___SR___IS___SL___SR);
...
static snet_stream_t *SNet____SHIELD_IN__simpleDes(snet_stream_t *in_buf, snet_info_t *info, int location)
{
  ...
  out_buf = SNetNameShift(in_buf, info, location, SNET__simpleDes__NUMBER_OF_LABELS,
              SNetVariantCreate(
                SNetIntListCreate(0), 
                SNetIntListCreate(9, T__simpleDes__mess, T__simpleDes__size, T__simpleDes__num_node, T__simpleDes__sleep_micro, T__simpleDes__change_mess, T__simpleDes__change_percent, T__simpleDes__window_size, T__simpleDes__thresh_hold, T__simpleDes__skip_update), 
                SNetIntListCreate(0)));
...
{
  if (fun == &SNet__simpleDes___IN___SL___SR___IS___SL___SR___ST) {
    return 1;
...
{
  if (id == 1) {
    return &SNet__simpleDes___IN___SL___SR___IS___SL___SR___ST;
  }if (id == 2) {
